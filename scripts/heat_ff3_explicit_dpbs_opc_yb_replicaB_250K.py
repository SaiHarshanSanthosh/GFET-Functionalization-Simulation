...
OUTPUT_CHECKPOINT = Path(
    "checkpoints/"
    "ff3_explicit_dpbs_opc_yb_replicaB_heating_250K.chk"
)

OUTPUT_LOG = Path(
    "analysis/"
    "ff3_explicit_dpbs_opc_yb_replicaB_heating_250K_log.csv"
)

OUTPUT_METADATA = Path(
    "analysis/"
    "ff3_explicit_dpbs_opc_yb_replicaB_heating_250K.json"
)
...
if prior_stage_metadata.get(
    ...
    raise RuntimeError(
        "250 K heating requires a successful "
        "HEATING_200K_PASS input stage. "
...
# ============================================================
# 13. CONTINUE 200 K VELOCITIES
#
# Preserve the velocities from the completed 200 K stage.
...
if (
    ...
    status = "HEATING_250K_PASS"
else:
    status = "HEATING_250K_COMPLETE_INSPECT_WARNINGS"
