...
HEATER = Path(
    "scripts/heat_ff3_wallfree_yb_200K.py"
)
...
if source.count(marker) != 1:
    raise RuntimeError(
        "Could not uniquely locate the 200 K MD boundary."
    )
...
print()
print("=" * 78)
print("STATIC FF-3 200 K CONTINUATION PREFLIGHT")
print("=" * 78)
...
print()
print("=" * 78)
print("STATIC 200 K PREFLIGHT COMPLETE")
print("=" * 78)
