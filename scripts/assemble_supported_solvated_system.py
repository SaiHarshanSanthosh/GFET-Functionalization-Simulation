...
# ============================================================
# 28. ONE-SIDED WATER WALL
#
# Acts ONLY on OPC oxygen particles.
# ============================================================

wall_force = openmm.CustomExternalForce(
...
if wall_force.getNumParticles() != (
    ...
    raise RuntimeError(
        "Water wall particle count mismatch."
    )
