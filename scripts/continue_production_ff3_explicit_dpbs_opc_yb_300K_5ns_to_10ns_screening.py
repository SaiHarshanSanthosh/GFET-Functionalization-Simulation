...
screening_metadata = {
    ...
    "production_before_this_segment_ps":
        5000.0,

    "production_after_this_segment_ps":
        10000.0,
...
metadata = {
    ...
    "stage":
        "5-to-10 ns continuation: 5 ns at 300 K NVT",
    ...
    "segment_start_production_ps":
        5000.0,

    "segment_end_production_ps":
        10000.0,

    "source_checkpoint_openmm_time_ps":
        checkpoint_time_ps,

    "expected_final_openmm_time_ps":
        checkpoint_time_ps + TOTAL_TIME_PS,
