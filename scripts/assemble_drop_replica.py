...
#   +
#   replica-specific number of rigid OPC waters
#   +
#   graphene z-support restraint
#   +
#   wall-free one-sided aqueous slab geometry
#
# IMPORTANT:
#
#   NO MD IS RUN.
...
parser = argparse.ArgumentParser(
    description=(
        "Assemble one validated FF-3 drop-replica "
        "OpenMM System without running MD."
    )
)
...
OUTPUT_METADATA = (
    ...
    /
    f"{DROP_ID}_assembly_check.json"
)
...
print()
print(f"ADDING {N_WATERS} OPC WATERS")
print("----------------------")
...
print()
print("=" * 72)
print(f"{DROP_ID.upper()} SUPPORTED SOLVATED ENERGY CHECK: COMPLETE")
print("=" * 72)
