...
INPUT_CHECKPOINT = (
    ROOT
    / "checkpoints"
    / "graphene_opc_wetting_25x50_yb_300K_500ps.chk"
)
...
OUTPUT_POSITIONS = (
    ...
    / "parameters"
    / "combined"
    / "graphene_opc_wetting_cylinder_25x50_yb_equilibrated_300K_5000ps_positions_nm.npy"
)
...
OUTPUT_VELOCITIES = (
    ...
    / "parameters"
    / "combined"
    / "graphene_opc_wetting_cylinder_25x50_yb_equilibrated_300K_5000ps_velocities_nm_per_ps.npy"
)

OUTPUT_LOG = (
    ROOT
    / "analysis"
    / "graphene_opc_wetting_25x50_yb_300K_500ps_to_5000ps_log.csv"
)
...
CHECKPOINT = (
    ROOT
    / "checkpoints"
    / "graphene_opc_wetting_25x50_yb_300K_5000ps.chk"
)
...
print(
    "State:           RESTORED from validated 500 ps checkpoint"
)
...
print()
print("=" * 80)
print("RUNNING CONTINUATION: 500 ps -> 5000 ps")
print("=" * 80)
...
print()
print("=" * 80)
print("5 ns CONTINUATION SUMMARY")
print("=" * 80)
...
print()
print(
    "GRAPHENE_OPC_WETTING_YB_300K_5000PS_CONTINUATION_PASS"
)
