...
RECOVERY_CHECKPOINT = Path(
    "checkpoints/"
    "pyrene_peg5_graphene_RECOVERY_300K_110to160ps.chk"
)
...
OUTPUT_POSITIONS = Path(
    "parameters/combined/"
    "pyrene_peg5_graphene_one_sided_opc_"
    "equilibrated_300K_160ps_positions_nm.npy"
)

OUTPUT_VELOCITIES = Path(
    "parameters/combined/"
    "pyrene_peg5_graphene_one_sided_opc_"
    "equilibrated_300K_160ps_velocities_nm_per_ps.npy"
)

OUTPUT_CHECKPOINT = Path(
    "checkpoints/"
    "pyrene_peg5_graphene_equilibration_300K_160ps.chk"
)

OUTPUT_LOG = Path(
    "analysis/"
    "equilibration_300K_110to160ps_log.csv"
)

OUTPUT_METADATA = Path(
    "analysis/"
    "equilibration_300K_160ps.json"
)

OUTPUT_TRAJECTORY = Path(
    "trajectories/"
    "pyrene_peg5_graphene_equilibration_300K_110to160ps_visible.dcd"
)
