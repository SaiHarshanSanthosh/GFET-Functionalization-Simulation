...
LANGEVIN_SEED = 2026082301
VELOCITY_SEED = 2026082302
...
POSITIONS_FILE = Path(
    ...
    "minimization_continue1_positions_nm.npy"
)
...
OUTPUT_CHECKPOINT = Path(
    "checkpoints/"
    "ff3_explicit_dpbs_opc_yb_replicaB_heating_050K.chk"
)

OUTPUT_LOG = Path(
    "analysis/"
    "ff3_explicit_dpbs_opc_yb_replicaB_heating_050K_log.csv"
)
...
if (
    ...
    status = "HEATING_050K_PASS"
else:
    status = "HEATING_050K_COMPLETE_INSPECT_WARNINGS"
