...
# ============================================================
# DROP-01 STAGE A - UNBIASED 2.00 nm FACE-ON DROP - 20 ps
#
# INPUT:
...
SYSTEM_XML = Path(
    "parameters/combined/"
    "drop01_faceon_2p00nm_wallfree_opc_yb.xml"
)

POSITIONS_FILE = Path(
    "parameters/combined/"
    "drop01_faceon_2p00nm_wallfree_opc_yb_positions_nm.npy"
)
...
OUTPUT_POSITIONS = Path(
    "parameters/combined/"
    "drop01_faceon_2p00nm_stageA_20ps_positions_nm.npy"
)

OUTPUT_VELOCITIES = Path(
    "parameters/combined/"
    "drop01_faceon_2p00nm_stageA_20ps_velocities_nm_per_ps.npy"
)

OUTPUT_CHECKPOINT = Path(
    "checkpoints/"
    "drop01_faceon_2p00nm_stageA_20ps.chk"
)

OUTPUT_LOG = Path(
    "analysis/"
    "drop01_faceon_2p00nm_stageA_20ps_log.csv"
)

OUTPUT_METADATA = Path(
    "analysis/"
    "drop01_faceon_2p00nm_stageA_20ps.json"
)

OUTPUT_DCD = Path(
    "trajectories/"
    "drop01_faceon_2p00nm_graphene_ligand.dcd"
)
...
# ============================================================
# 13. INITIALIZE DROP-01 VELOCITIES AT t = 0
#
# One deterministic Maxwell-Boltzmann draw is performed here.
# It defines Drop-01 and is NEVER repeated during continuation.
# ============================================================
...
print()
print("DROP-01 LINKER STATE AT t = 0")
print("-----------------------------")
print(
...
print()
print("=" * 78)
print("RUNNING DROP-01 STAGE A: 0 -> 20 ps")
print("=" * 78)
...
if (
    ...
    status = (
        "DROP01_STAGEA_20PS_INSPECT_WARNINGS"
    )
...
metadata = {
    ...
    "stage":
        "Drop-01 unbiased face-on 2.00 nm, Stage A 0-20 ps",
...
print()
print("=" * 78)
print("DROP-01 STAGE A: COMPLETE")
print("=" * 78)
