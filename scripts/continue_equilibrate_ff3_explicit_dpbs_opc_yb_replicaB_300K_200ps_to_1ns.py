...
OUTPUT_LOG = Path(
    "analysis/"
    "ff3_explicit_dpbs_opc_yb_replicaB_equilibration_300K_1ns_log.csv"
)
...
if prior_stage_metadata.get(
    ...
    raise RuntimeError(
        "1 ns continuation requires a successful "
        "EQUILIBRATION_300K_PASS 200 ps input stage. "
...
# ============================================================
# ============================================================
# 12. LOAD EXACT 200 ps EQUILIBRATION CHECKPOINT
#
# NPY arrays are comparison references ONLY.
# They never initialize or modify this Context.
#
# NO position reset
# NO velocity reset/regeneration
# NO time reset
# NO constraint reprojection
# NO virtual-site recomputation
# NO minimization
# ============================================================
...
print()
print("=" * 78)
print("EXACT 200 ps EQUILIBRATION CHECKPOINT")
print("=" * 78)
...
print()
print("=" * 78)
print("INITIAL STATE FROM EXACT 200 ps CHECKPOINT")
print("=" * 78)
...
# ============================================================
# 17. RUN +800 ps AT 300 K ? 200 ps -> 1.0 ns cumulative
# ============================================================
...
if (
    ...
    status = "EQUILIBRATION_300K_1NS_PASS"
else:
    status = "EQUILIBRATION_300K_1NS_COMPLETE_INSPECT_WARNINGS"
...
metadata = {
    ...
    "scientific_cumulative_equilibration_ps":
        1000.0,

    "position_reset_after_checkpoint":
        False,

    "velocity_reset_after_checkpoint":
        False,

    "time_reset_after_checkpoint":
        False,

    "constraint_reprojection_after_checkpoint":
        False,
