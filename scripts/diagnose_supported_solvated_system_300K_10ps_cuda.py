...
OUTPUT_CHECKPOINT = Path(
    "checkpoints/"
    "pyrene_peg5_graphene_diagnostic_300K_110ps.chk"
)

OUTPUT_LOG = Path(
    "analysis/"
    "diagnostic_300K_100to110ps_log.csv"
)

OUTPUT_METADATA = Path(
    "analysis/"
    "diagnostic_300K_100to110ps.json"
)

OUTPUT_TRAJECTORY = Path(
    "trajectories/"
    "pyrene_peg5_graphene_diagnostic_300K_100to110ps_visible.dcd"
)
