...
# ============================================================
# ZERO-STEP PRODUCTION PREFLIGHT RESULT
# ============================================================

print()
print("=" * 78)
print("5 ns PRODUCTION ZERO-STEP PREFLIGHT: PASS")
print("=" * 78)

print("MD steps executed: 0")
print("Production coordinates written: NO")
print("Production velocities written: NO")
print("Production checkpoint written: NO")
print("Production CSV written: NO")
print("Production metadata written: NO")
print("Trajectory written: NO")

print()
print(
    "Checkpoint state was loaded and inspected without "
    "modification."
)

print(
    "Ready for production-runner instrumentation."
)
