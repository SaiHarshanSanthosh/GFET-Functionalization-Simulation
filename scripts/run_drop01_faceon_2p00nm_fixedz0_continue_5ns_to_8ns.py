...
OUTPUT_POSITIONS = Path(
    "parameters/combined/"
    "drop01_faceon_2p00nm_fixedz0_8ns_positions_nm.npy"
)

OUTPUT_VELOCITIES = Path(
    "parameters/combined/"
    "drop01_faceon_2p00nm_fixedz0_8ns_velocities_nm_per_ps.npy"
)

OUTPUT_CHECKPOINT = Path(
    "checkpoints/"
    "drop01_faceon_2p00nm_fixedz0_8ns.chk"
)
...
OUTPUT_METADATA = Path(
    "analysis/"
    "drop01_faceon_2p00nm_fixedz0_8ns.json"
)
...
RESCUE_CHECKPOINT = Path(
    "checkpoints/"
    "drop01_faceon_2p00nm_fixedz0_5ns_to_8ns_rescue.chk"
)
...
print()
print("=" * 78)
print("RUNNING DROP-01 CONTINUATION: 5000 -> 8000 ps")
print("=" * 78)
...
if (
    ...
    status = (
        "DROP01_8NS_CONTINUATION_INSPECT_WARNINGS"
    )
...
metadata = {
    ...
    "stage":
        "Drop-01 unbiased face-on 2.00 nm, exact checkpoint continuation 5000-8000 ps",
...
print()
print("=" * 78)
print("DROP-01 8 ns CONTINUATION SUMMARY")
print("=" * 78)
...
print()
print("=" * 78)
print("DROP-01 8 ns CONTINUATION: COMPLETE")
print("=" * 78)
