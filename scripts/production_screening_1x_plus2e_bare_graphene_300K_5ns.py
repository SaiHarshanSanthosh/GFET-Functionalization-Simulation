...
SYSTEM_XML = Path("parameters/iff/charged_screening/screening_1x_plus2e_bare_graphene.xml")

POSITIONS_FILE = Path("parameters/iff/charged_screening/screening_1x_plus2e_bare_graphene_equilibrated_300K_positions_nm.npy")

VELOCITIES_FILE = Path("parameters/iff/charged_screening/screening_1x_plus2e_bare_graphene_equilibrated_300K_velocities_nm_per_ps.npy")


ASSEMBLY_METADATA = Path("analysis/screening_1x_plus2e_bare_graphene_assembly_check.json")

PRIOR_STAGE_METADATA = Path("analysis/screening_1x_plus2e_bare_graphene_equilibration_300K.json")

INPUT_CHECKPOINT = Path("checkpoints/screening_1x_plus2e_bare_graphene_equilibration_300K.chk")
...
OUTPUT_POSITIONS = Path("parameters/iff/charged_screening/screening_1x_plus2e_bare_graphene_production_300K_5ns_positions_nm.npy")

OUTPUT_VELOCITIES = Path("parameters/iff/charged_screening/screening_1x_plus2e_bare_graphene_production_300K_5ns_velocities_nm_per_ps.npy")

OUTPUT_CHECKPOINT = Path("checkpoints/screening_1x_plus2e_bare_graphene_production_300K_5ns.chk")

OUTPUT_LOG = Path("analysis/screening_1x_plus2e_bare_graphene_production_300K_5ns_log.csv")

OUTPUT_METADATA = Path("analysis/screening_1x_plus2e_bare_graphene_production_300K_5ns.json")

SCREENING_TRAJECTORY = Path("analysis/screening_1x_plus2e_bare_graphene_production_300K_5ns_screening_trajectory_float32.npy")

SCREENING_METADATA = Path("analysis/screening_1x_plus2e_bare_graphene_production_300K_5ns_screening_trajectory.json")

RESCUE_CHECKPOINT = Path("checkpoints/screening_1x_plus2e_bare_graphene_production_300K_5ns_rescue.chk")

RESCUE_PROGRESS = Path("analysis/screening_1x_plus2e_bare_graphene_production_300K_5ns_rescue_progress.json")
...
if prior_stage_metadata.get(
    "status"
) != "EQUILIBRATION_300K_PASS":

    raise RuntimeError(
        "5 ns production requires a successful "
        "EQUILIBRATION_300K_PASS input stage. "
...
metadata_ligand_particles = int(
    assembly_metadata["ligand_particles"]
)
...
# 200 ps, so the checkpoint clock may be ~200 ps. We preserve
...
print(
    "Do not extend beyond 5 ns until this output is inspected."
)
