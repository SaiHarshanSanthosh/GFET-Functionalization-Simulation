...
OUTPUT_FIGURE = (
    ...
    / "analysis"
    / "figures"
    / "22_graphene_opc_wetting_25x50_contact_angle_5ns_timeblocks.png"
)
...
print()
print("=" * 80)
print("GRAPHENE / OPC CONTACT-ANGLE 5 ns TEMPORAL CONVERGENCE")
print("=" * 80)
...
ax.axhline(
    91.970,
    linestyle="--",
    label="Earlier 300-500 ps fit (91.97 deg)",
)
...
ax.set_title(
    "Graphene-OPC Contact Angle: 5 ns Temporal Stability"
)
...
metadata = {
    ...
    "note": (
        "5 ns temporal convergence diagnostic for the nanoscale "
