...
OUTPUT_CHECKPOINT = Path(
    "checkpoints/"
    "pyrene_peg5_graphene_equilibration_300K_100ps.chk"
)

OUTPUT_LOG = Path(
    "analysis/"
    "equilibration_300K_100ps_log.csv"
)

OUTPUT_METADATA = Path(
    "analysis/"
    "equilibration_300K_100ps.json"
)

OUTPUT_TRAJECTORY = Path(
    "trajectories/"
    "pyrene_peg5_graphene_equilibration_300K_100ps_visible.dcd"
)
...
print()
print("=" * 78)
print("300 K NVT EQUILIBRATION - 100 ps")
print("=" * 78)
...
print(
    "Inspect the 100 ps trends before starting production."
)
