...
# ============================================================
# 300 K NVT EQUILIBRATION - 100 ps
#
# INPUT:
#   Completed FF-3 300 K wall-free/YB heating state.
...
OUTPUT_CHECKPOINT = Path(
    "checkpoints/"
    "ff3_wallfree_yb_equilibration_300K_100ps.chk"
)

OUTPUT_LOG = Path(
    "analysis/"
    "ff3_wallfree_yb_equilibration_300K_100ps_log.csv"
)

OUTPUT_METADATA = Path(
    "analysis/"
    "ff3_wallfree_yb_equilibration_300K_100ps.json"
)
...
# 300 K heating occupied 100--120 ps.
# Continue the cumulative timeline from 120 ps.
context.setTime(
    120.0
    * unit.picoseconds
)
...
print()
print("=" * 78)
print("RUNNING 100 ps 300 K NVT EQUILIBRATION")
print("=" * 78)
...
if (
    ...
    status = (
        "EQUILIBRATION_300K_100PS_COMPLETE_INSPECT_WARNINGS"
    )
