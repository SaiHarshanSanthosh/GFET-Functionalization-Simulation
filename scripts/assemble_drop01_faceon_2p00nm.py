...
OUTPUT_METADATA = Path(
    "analysis/"
    "drop01_faceon_2p00nm_assembly_check.json"
)
...
# Derive the supported graphene reference plane from the
# actual carbon coordinates.  No graphene height is hardcoded.
graphene_z0_nm = float(
    np.mean(
        solute_positions[
            :N_CARBON,
            2,
