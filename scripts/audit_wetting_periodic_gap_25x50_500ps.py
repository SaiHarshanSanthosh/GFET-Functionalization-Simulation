...
OUTPUT_JSON = (
    ROOT / "analysis"
    / "graphene_opc_wetting_25x50_periodic_gap_300to500ps.json"
)

OUTPUT_FIGURE = (
    ROOT / "analysis" / "figures"
    / "19_graphene_opc_wetting_25x50_periodic_gap_300to500ps.png"
)
...
ax.set_title(
    "Graphene-OPC Wetting 25x50: 300-500 ps Periodic-Gap Audit"
)
