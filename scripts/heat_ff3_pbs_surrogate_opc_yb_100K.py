...
# ============================================================
# STAGED NVT HEATING - STAGE 2: 100 K
#
# INPUT:
#   Completed FF-3 50 K wall-free/YB state.
...
PRIOR_STAGE_METADATA = Path(
    "analysis/"
    "ff3_pbs_surrogate_opc_yb_heating_050K.json"
)
...
OUTPUT_CHECKPOINT = Path(
    "checkpoints/"
    "ff3_pbs_surrogate_opc_yb_heating_100K.chk"
)

OUTPUT_LOG = Path(
    "analysis/"
    "ff3_pbs_surrogate_opc_yb_heating_100K_log.csv"
)
...
# ============================================================
# 12. LOAD 50 K CONTINUATION POSITIONS
# ============================================================
...
# ============================================================
# 13. CONTINUE SAVED 50 K VELOCITIES
#
...
# 50 K occupied 0--20 ps.
# Continue the cumulative timeline from 20 ps.
context.setTime(
    20.0
    * unit.picoseconds
)
...
print()
print("=" * 78)
print("STAGED NVT HEATING - STAGE 2")
print("=" * 78)
...
print()
print("=" * 78)
print("INITIAL STATE ENTERING 100 K STAGE")
print("=" * 78)
...
print()
print("=" * 78)
print("100 K NVT HEATING: COMPLETE")
print("=" * 78)
