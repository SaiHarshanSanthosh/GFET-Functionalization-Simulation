...
# ============================================================
# STAGED NVT HEATING - STAGE 6: 300 K
#
# INPUT:
#   Completed FF-3 250 K wall-free/YB state.
...
OUTPUT_CHECKPOINT = Path(
    "checkpoints/"
    "ff3_wallfree_yb_heating_300K.chk"
)

OUTPUT_LOG = Path(
    "analysis/"
    "ff3_wallfree_yb_heating_300K_log.csv"
)

OUTPUT_METADATA = Path(
    "analysis/"
    "ff3_wallfree_yb_heating_300K.json"
)
...
# ============================================================
# 12. LOAD 250 K CONTINUATION POSITIONS
# ============================================================
...
# ============================================================
# 13. CONTINUE SAVED 250 K VELOCITIES
#
...
# 250 K occupied 80--100 ps.
# Continue the cumulative timeline from 100 ps.
context.setTime(
    100.0
    * unit.picoseconds
)
...
print()
print("=" * 78)
print("STAGED NVT HEATING - STAGE 6")
print("=" * 78)
...
if (
    ...
    status = (
        "HEATING_300K_COMPLETE_INSPECT_WARNINGS"
    )
...
print()
print("=" * 78)
print("300 K NVT HEATING: COMPLETE")
print("=" * 78)
...
print(
    "Do not start 300 K equilibration until this output is inspected."
)
