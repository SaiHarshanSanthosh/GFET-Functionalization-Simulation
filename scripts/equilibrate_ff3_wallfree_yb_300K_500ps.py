...
# ============================================================
# 300 K NVT EQUILIBRATION - 500 ps CONTINUATION
#
# INPUT:
#   Completed FF-3 300 K 100 ps equilibration state.
#   Positions and velocities are continued directly.
#
# THIS STAGE:
#   NVT equilibration continuation
#   300 K
#   500 ps
#   1 fs timestep
...
POSITIONS_FILE = Path(
    ...
    "equilibrated_300K_100ps_positions_nm.npy"
)

VELOCITIES_FILE = Path(
    "parameters/combined/"
    "ff3_pyrene_peg5_graphene_wallfree_opc_yb_"
    "equilibrated_300K_100ps_velocities_nm_per_ps.npy"
)
...
OUTPUT_VELOCITIES = Path(
    "parameters/combined/"
    "ff3_pyrene_peg5_graphene_wallfree_opc_yb_"
    "equilibrated_300K_600ps_total_velocities_nm_per_ps.npy"
)

OUTPUT_CHECKPOINT = Path(
    "checkpoints/"
    "ff3_wallfree_yb_equilibration_300K_600ps_total.chk"
)

OUTPUT_LOG = Path(
    "analysis/"
    "ff3_wallfree_yb_equilibration_300K_600ps_total_log.csv"
)

OUTPUT_METADATA = Path(
    "analysis/"
    "ff3_wallfree_yb_equilibration_300K_600ps_total.json"
)
...
# ============================================================
# 13. CONTINUE SAVED 300 K VELOCITIES
#
...
# The first 100 ps equilibration occupied 120--220 ps.
# Continue the cumulative trajectory from 220 ps.
context.setTime(
    220.0
    * unit.picoseconds
)
...
print()
print("=" * 78)
print("RUNNING 500 ps 300 K NVT EQUILIBRATION CONTINUATION")
print("=" * 78)
...
if (
    ...
    status = (
        "EQUILIBRATION_300K_500PS_CONTINUATION_PASS"
    )
    ...
    status = (
        "EQUILIBRATION_300K_500PS_CONTINUATION_INSPECT_WARNINGS"
    )
...
metadata = {
    ...
    "stage":
        "300 K equilibration +500 ps continuation (600 ps total)",
...
print(
    "Do not start production/drop simulations until this equilibration is inspected."
)
