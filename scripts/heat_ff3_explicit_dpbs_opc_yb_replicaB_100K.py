...
PRIOR_STAGE_METADATA = Path(
    "analysis/"
    "ff3_explicit_dpbs_opc_yb_replicaB_heating_050K.json"
)
...
OUTPUT_CHECKPOINT = Path(
    "checkpoints/"
    "ff3_explicit_dpbs_opc_yb_replicaB_heating_100K.chk"
)

OUTPUT_LOG = Path(
    "analysis/"
    "ff3_explicit_dpbs_opc_yb_replicaB_heating_100K_log.csv"
)
...
#
# Preserve the velocities from the completed 50 K stage.
...
if (
    ...
    status = "HEATING_100K_PASS"
else:
    status = "HEATING_100K_COMPLETE_INSPECT_WARNINGS"
