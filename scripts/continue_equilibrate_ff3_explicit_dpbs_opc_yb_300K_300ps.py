...
PRIOR_STAGE_METADATA = Path(
    "analysis/"
    "ff3_explicit_dpbs_opc_yb_equilibration_300K.json"
)
...
OUTPUT_POSITIONS = Path(
    "parameters/combined/"
    "ff3_explicit_dpbs_opc_yb_"
    "equilibrated_300K_continue300ps_positions_nm.npy"
)

OUTPUT_VELOCITIES = Path(
    "parameters/combined/"
    "ff3_explicit_dpbs_opc_yb_"
    "equilibrated_300K_continue300ps_velocities_nm_per_ps.npy"
)

OUTPUT_CHECKPOINT = Path(
    "checkpoints/"
    "ff3_explicit_dpbs_opc_yb_equilibration_300K_continue300ps.chk"
)

OUTPUT_LOG = Path(
    "analysis/"
    "ff3_explicit_dpbs_opc_yb_equilibration_300K_continue300ps_log.csv"
)

OUTPUT_METADATA = Path(
    "analysis/"
    "ff3_explicit_dpbs_opc_yb_equilibration_300K_continue300ps.json"
)
...
# ============================================================
# 17. RUN 300 ps AT 300 K
# ============================================================

print()
print("=" * 78)
print("RUNNING 300 K NVT EQUILIBRATION CONTINUATION")
print("=" * 78)
...
if (
    ...
    status = "EQUILIBRATION_300K_CONTINUE300PS_PASS"
else:
    status = "EQUILIBRATION_300K_CONTINUE300PS_COMPLETE_INSPECT_WARNINGS"
...
metadata = {
    ...
    "stage":
        "300 K equilibration continuation 300 ps",
...
print()
print("=" * 78)
print("300 K EQUILIBRATION CONTINUATION SUMMARY")
print("=" * 78)
