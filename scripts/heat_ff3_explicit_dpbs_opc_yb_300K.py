...
OUTPUT_CHECKPOINT = Path(
    "checkpoints/"
    "ff3_explicit_dpbs_opc_yb_heating_300K.chk"
)

OUTPUT_LOG = Path(
    "analysis/"
    "ff3_explicit_dpbs_opc_yb_heating_300K_log.csv"
)

OUTPUT_METADATA = Path(
    "analysis/"
    "ff3_explicit_dpbs_opc_yb_heating_300K.json"
)
...
if prior_stage_metadata.get(
    ...
    raise RuntimeError(
        "300 K heating requires a successful "
        "HEATING_250K_PASS input stage. "
...
if (
    ...
    status = "HEATING_300K_PASS"
else:
    status = "HEATING_300K_COMPLETE_INSPECT_WARNINGS"
