...
PRIOR_STAGE_METADATA = Path(
    "analysis/"
    "ff3_explicit_dpbs_opc_yb_replicaB_heating_100K.json"
)
...
OUTPUT_CHECKPOINT = Path(
    "checkpoints/"
    "ff3_explicit_dpbs_opc_yb_replicaB_heating_150K.chk"
)

OUTPUT_LOG = Path(
    "analysis/"
    "ff3_explicit_dpbs_opc_yb_replicaB_heating_150K_log.csv"
)
...
# ============================================================
# 13. CONTINUE 100 K VELOCITIES
#
# Preserve the velocities from the completed 100 K stage.
...
if (
    ...
    status = "HEATING_150K_PASS"
else:
    status = "HEATING_150K_COMPLETE_INSPECT_WARNINGS"
