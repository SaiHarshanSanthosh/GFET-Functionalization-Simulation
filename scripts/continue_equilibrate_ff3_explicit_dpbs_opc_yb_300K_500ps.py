...
OUTPUT_LOG = Path(
    "analysis/"
    "ff3_explicit_dpbs_opc_yb_equilibration_300K_continue500ps_log.csv"
)
...
if prior_stage_metadata.get(
    "status"
) != "EQUILIBRATION_300K_CONTINUE300PS_PASS":

    raise RuntimeError(
        "300 K continuation requires a successful "
        "EQUILIBRATION_300K_CONTINUE300PS_PASS input stage. "
...
if (
    ...
    status = "EQUILIBRATION_300K_CONTINUE500PS_PASS"
else:
    status = "EQUILIBRATION_300K_CONTINUE500PS_COMPLETE_INSPECT_WARNINGS"
...
metadata = {
    ...
    "stage":
        "300 K equilibration continuation 500 ps",
