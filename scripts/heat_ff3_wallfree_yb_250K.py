...
# ============================================================
# STAGED NVT HEATING - STAGE 5: 250 K
#
# INPUT:
#   Completed FF-3 200 K wall-free/YB state.
...
POSITIONS_FILE = Path(
    ...
    "heated_200K_positions_nm.npy"
)

VELOCITIES_FILE = Path(
    "parameters/combined/"
    "ff3_pyrene_peg5_graphene_wallfree_opc_yb_"
    "heated_200K_velocities_nm_per_ps.npy"
)
...
OUTPUT_POSITIONS = Path(
    "parameters/combined/"
    "ff3_pyrene_peg5_graphene_wallfree_opc_yb_"
    "heated_250K_positions_nm.npy"
)

OUTPUT_VELOCITIES = Path(
    "parameters/combined/"
    "ff3_pyrene_peg5_graphene_wallfree_opc_yb_"
    "heated_250K_velocities_nm_per_ps.npy"
)

OUTPUT_CHECKPOINT = Path(
    "checkpoints/"
    "ff3_wallfree_yb_heating_250K.chk"
)

OUTPUT_LOG = Path(
    "analysis/"
    "ff3_wallfree_yb_heating_250K_log.csv"
)

OUTPUT_METADATA = Path(
    "analysis/"
    "ff3_wallfree_yb_heating_250K.json"
)
...
# ============================================================
# 10. CREATE 250 K LANGEVIN INTEGRATOR
# ============================================================
...
# ============================================================
# 12. LOAD 200 K CONTINUATION POSITIONS
# ============================================================
...
# ============================================================
# 13. CONTINUE SAVED 200 K VELOCITIES
#
...
# 200 K occupied 60--80 ps.
# Continue the cumulative timeline from 80 ps.
context.setTime(
    80.0
    * unit.picoseconds
)
...
print()
print("=" * 78)
print("STAGED NVT HEATING - STAGE 5")
print("=" * 78)
...
print()
print("=" * 78)
print("INITIAL STATE ENTERING 250 K STAGE")
print("=" * 78)
...
# ============================================================
# 17. RUN 20 ps AT 250 K
# ============================================================

print()
print("=" * 78)
print("RUNNING 250 K NVT")
print("=" * 78)
...
if (
    ...
    status = (
        "HEATING_250K_COMPLETE_INSPECT_WARNINGS"
    )
...
print()
print("=" * 78)
print("250 K NVT HEATING: COMPLETE")
print("=" * 78)
...
print(
    "Do not start 300 K until this output is inspected."
)
