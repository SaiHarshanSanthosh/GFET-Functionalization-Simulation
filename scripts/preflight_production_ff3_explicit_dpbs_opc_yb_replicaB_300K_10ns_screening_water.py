...
INPUT_CHECKPOINT = Path(
    "checkpoints/"
    "ff3_explicit_dpbs_opc_yb_replicaB_equilibration_300K_1ns.chk"
)
...
print()
print("=" * 78)
print("INITIAL STATE ENTERING 10 ns PRODUCTION")
print("=" * 78)
...
# ============================================================
# RUNTIME PREFLIGHT STOP
#
# Everything above this point has executed, including:
#   - input/output existence checks
#   - System deserialization
#   - assembly metadata validation
#   - Hamiltonian / force audits
#   - exact OpenMM checkpoint loading
#   - checkpoint-vs-NPY continuity verification
#   - initial state evaluation
#   - one-sided aqueous checks
#   - OPC O-H-H-M layout audit
#   - OPC charge / virtual-site reconstruction audit
#
# Nothing below this point executes during preflight.
# ============================================================

print()
print("=" * 78)
print("REPLICA B 10 ns PRODUCTION RUNTIME PREFLIGHT: PASS")
print("=" * 78)

print()
print("Production integration steps executed: 0")
print("Trajectory files created: NONE")
print("Production checkpoints written: NONE")
print("Production state modified after checkpoint load: NONE")
print()
...
# ============================================================
# 17. RUN 10 ns PRODUCTION MD AT 300 K
# ============================================================
