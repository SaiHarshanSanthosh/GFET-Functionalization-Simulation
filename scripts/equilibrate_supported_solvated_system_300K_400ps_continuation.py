...
# ============================================================
# 300 K NVT EQUILIBRATION - 400 ps CONTINUATION
#
# INPUT:
...
OUTPUT_LOG = Path(
    "analysis/"
    "equilibration_300K_100to500ps_log.csv"
)
...
OUTPUT_TRAJECTORY = Path(
    "trajectories/"
    "pyrene_peg5_graphene_equilibration_300K_100to500ps_visible.dcd"
)
...
print()
print("=" * 78)
print("300 K NVT EQUILIBRATION - 400 ps CONTINUATION")
print("=" * 78)
...
# ============================================================
# 19. RUN 400 ps CONTINUATION AND WRITE VMD DCD
# ============================================================
...
print(
    f"Mean temperature, last 200 ps: "
...
print(
    f"Mean pyrene height, last 200 ps: "
