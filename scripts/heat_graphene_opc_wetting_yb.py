...
INPUT_POSITIONS = (
    ...
    / "parameters"
    / "combined"
    / "graphene_opc_wetting_cylinder_yb_minimized_converged_positions_nm.npy"
)
...
OUTPUT_CSV = (
    ROOT
    / "analysis"
    / "graphene_opc_wetting_yb_heating.csv"
)

OUTPUT_JSON = (
    ROOT
    / "analysis"
    / "graphene_opc_wetting_yb_heating.json"
)

CHECKPOINT = (
    ROOT
    / "checkpoints"
    / "graphene_opc_wetting_yb_heated_300K.chk"
)
