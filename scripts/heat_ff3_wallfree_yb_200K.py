...
# ============================================================
# STAGED NVT HEATING - STAGE 4: 200 K
#
# INPUT:
#   Completed FF-3 150 K wall-free/YB state.
...
OUTPUT_CHECKPOINT = Path(
    "checkpoints/"
    "ff3_wallfree_yb_heating_200K.chk"
)

OUTPUT_LOG = Path(
    "analysis/"
    "ff3_wallfree_yb_heating_200K_log.csv"
)

OUTPUT_METADATA = Path(
    "analysis/"
    "ff3_wallfree_yb_heating_200K.json"
)
...
# ============================================================
# 10. CREATE 200 K LANGEVIN INTEGRATOR
# ============================================================
...
# ============================================================
# 12. LOAD 150 K CONTINUATION POSITIONS
# ============================================================
...
# ============================================================
# 13. CONTINUE SAVED 150 K VELOCITIES
#
...
# 150 K occupied 40--60 ps.
# Continue the cumulative timeline from 60 ps.
context.setTime(
    60.0
    * unit.picoseconds
)
...
print()
print("=" * 78)
print("STAGED NVT HEATING - STAGE 4")
print("=" * 78)
...
print()
print("=" * 78)
print("INITIAL STATE ENTERING 200 K STAGE")
print("=" * 78)
...
# ============================================================
# 17. RUN 20 ps AT 200 K
# ============================================================

print()
print("=" * 78)
print("RUNNING 200 K NVT")
print("=" * 78)
...
if (
    ...
    status = (
        "HEATING_200K_COMPLETE_INSPECT_WARNINGS"
    )
...
print()
print("=" * 78)
print("200 K NVT HEATING: COMPLETE")
print("=" * 78)
...
print(
    "Do not start 250 K until this output is inspected."
)
