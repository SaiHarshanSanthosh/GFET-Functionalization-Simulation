...
PRIOR_STAGE_METADATA = Path(
    "analysis/"
    "ff3_explicit_dpbs_opc_yb_replicaB_heating_150K.json"
)
...
OUTPUT_CHECKPOINT = Path(
    "checkpoints/"
    "ff3_explicit_dpbs_opc_yb_replicaB_heating_200K.chk"
)

OUTPUT_LOG = Path(
    "analysis/"
    "ff3_explicit_dpbs_opc_yb_replicaB_heating_200K_log.csv"
)

OUTPUT_METADATA = Path(
    "analysis/"
    "ff3_explicit_dpbs_opc_yb_replicaB_heating_200K.json"
)
...
if prior_stage_metadata.get(
    ...
    raise RuntimeError(
        "200 K heating requires a successful "
        "HEATING_150K_PASS input stage. "
...
# ============================================================
# 13. CONTINUE 150 K VELOCITIES
#
# Preserve the velocities from the completed 150 K stage.
...
if (
    ...
    status = "HEATING_200K_PASS"
else:
    status = "HEATING_200K_COMPLETE_INSPECT_WARNINGS"
